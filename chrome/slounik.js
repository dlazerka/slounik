...
angular.module('name.dlazerka.slounik', [])
	.constant('REST_API_URL', 'http://slounik.dlazerka.name/rest')
	...
	.controller('SlounikController', function($scope, $http, REST_API_URL) {
		...
		$scope.$watch('input', function() {
			...
			$http.get(REST_API_URL + '/entry/search/be/ru/' + encodeURI($scope.input))
